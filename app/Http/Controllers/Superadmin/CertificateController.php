...
class CertificateController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        Auth::user()->notify(new DocumentActionNotification('Dokumen "' . $certificate->title . '" berhasil dihapus.'));

        return redirect()->route('superadmin.sertifikat.index')->with('success', 'Dokumen berhasil dihapus.');
    }
