...
class LocaController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('superadmin.loca.index', compact('locas'));
    }

    public function create()
    {
        return view('superadmin.loca.create');
    }
...
public function store(Request $request)
{
    ...
    return redirect()->route('superadmin.loca.index')->with('success', 'Dokumen LOCA berhasil diupload.');
}
    ...
    public function show($id)
    {
        ...
        return view('superadmin.loca.show', compact('loca', 'fileUrl'));
    }


    public function edit(Loca $loca)
    {
        return view('superadmin.loca.edit', compact('loca'));
    }
    ...
    public function update(Request $request, Loca $loca)
{
    ...
    return redirect()->route('superadmin.loca.index')->with('success', 'Dokumen LOCA berhasil diperbarui.');
}
    ...
    public function destroy(Loca $loca)
    {
        ...
        return redirect()->route('superadmin.loca.index')->with('success', 'Dokumen LOCA berhasil dihapus.');
    }
}
