    ...
    <form action="{{ route('superadmin.documents.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <select class="form-control" id="category" name="category" required onchange="toggleSOPFields()">
                ...
                <option value="BAB 2">BAB 2 (Gambaran Umum)</option>
                <option value="BAB 3">BAB 3 (Struktur Organisasi)</option>
                <option value="BAB 4">BAB 4 (Pelayanan Manajemen Lalu Lintas Dan Telekomunkasi Penerbangan)</option>
                <option value="BAB 5">BAB 5 (Fasilitas Dan Peralatan)</option>
                <option value="BAB 6">BAB 6 (Personel)</option>
                <option value="BAB 7">BAB 7 (Standar Pelayanan)</option>
                <option value="BAB 8">BAB 8 (Sistem Manajemen Keselamatan)</option>
                <option value="BAB 9">BAB 9 (Rencana Kontigensi)</option>
                <option value="BAB 10">BAB 10 (Dokumen Dan Rekaman)</option>
                <option value="BAB 11">BAB 11 (Prinsip Human Faktor)</option>
        ...
        <a href="{{route('superadmin.documents.index')}}" class="btn btn-warning">Kembali</a>
