...
<div class="container bg-white p-4 rounded shadow-sm">
    ...
    <form action="{{ route('superadmin.loca.update', $loca->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <a href="{{ route('superadmin.loca.index') }}" class="btn btn-warning">Batal</a>
    </form>
</div>
@endsection
