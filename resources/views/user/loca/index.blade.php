...
<div class="container bg-white p-4 rounded shadow-sm">
    ...
    <form action="{{ route('user.loca.index') }}" method="GET" class="mb-4">
        <div class="row g-2 align-items-end">
            ...
            <div class="col-md-3">
                ...
                <select id="category" name="category" class="form-control">
                    ...
                    @foreach(['Internal', 'Eksternal'] as $cat)
        ...
        <tbody>
            @forelse($locas as $loca)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('user.loca.show', $loca->id) }}" class="btn btn-sm btn-info">Detail</a>
                    </td>
                </tr>
            @empty
                <tr>
